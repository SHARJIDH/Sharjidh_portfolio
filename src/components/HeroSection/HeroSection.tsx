...
const HeroSection: React.FC = () => {
  const texts = ["Full Stack Developer", "Student", "Competitive Programmer"];
  const colorSet = {
    primary: "#d2691e",
    secondary: "#ff8c00",
    gradient: ["#d2691e", "#ff8c00"],
      ...
      >
        <div className="text-center md:text-left md:w-5/12">
          ...
          <p className="my-4 text-2xl break-words text-pretty text-black">
            ...
            practicipate in Competitive Programming
          </p>
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex gap-6 items-center">
              <SocialButton
                ...
                ariaLabel="GitHub"
                link="https://github.com/SHARJIDH"
                color={colorSet.primary}
              />
              <SocialButton
                icon={<LinkedInLogoIcon className="w-10 h-10" />}
                ariaLabel="LinkedIn"
                link="https://www.linkedin.com/in/shaik-sharjidh-51500122b/"
                color={colorSet.primary}
              />
              <SocialButton
                icon={<MailPlus className="w-10 h-10" />}
                ariaLabel="Email"
                link="mailto:sharjidh2003@gmail.com"
                color={colorSet.primary}
              />
            </div>
          </div>
