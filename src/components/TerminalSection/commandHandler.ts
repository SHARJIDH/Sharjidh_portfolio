...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A quote displaying webstie featuring hand-picked quotes from 'The ContentMatrix'.",
  },
];
  ...
  switch (true) {
    case trimmedCmd === "help":
      return [
        ...
        "- sharjidh: Show information about me",
    ...
    case trimmedCmd === "sharjidh":
      return "Hey there! I'm sharjidh, a full-stack developer who has experience in MERN, currently learning nextJs, interested in DevOps as well.";
